...
async function bestStudent(originalMessage) {
  const record = await bestStudentChannel.call(this, DB.STUDENT.CALL);
...
async function worstStudent(originalMessage) {
  const record = await worstStudentChannel.call(this, DB.STUDENT.CALL);
...
async function listStudent(originalMessage) {
  const record = await listStudentChannel.call(this, DB.STUDENT.CALL);
