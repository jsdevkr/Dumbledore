module.exports = {
  ...
  OUTPUT: {
    POINT_TO: (house, result) => 'Congratulations ' + house.capitalizeFirstLetter() + '! ' + house.capitalizeFirstLetter() + ' house has ' + result.points + ' points!',
    POINT_FROM: (house, result) => 'Alas ' + house.capitalizeFirstLetter() + '. ' + house.capitalizeFirstLetter() + ' house now only has ' + result.points + ' points. Do not dwell on your misdeeds, there is potential for greatness in all students!',
    GET_WINNER: (house, result) => house.capitalizeFirstLetter() + ' House: ' + result.points + '\n',
    ...
    CAN_I_JOIN: house => 'Weld  come ' + student.capitalizeFirstLetter() + ' the house of ' + house.capitalizeFirstLetter() + ' expects great things from you!',
    OBLIVIATE: 'Poof, even a remembrall wont help you now Gilderoy',
    GET_BEST_STUDENT: record => 'The head boy/girl of ' + record.house.capitalizeFirstLetter() + ' is @' + record.username + ' with ' + record.points_earned + ' points!',
    ABOUT_FROGS: '\n I think they\'ve earned some Chocolate Frogs.',
    GET_MEANEST_STUDENT: record => 'The student most likely to join the Inquisitorial Squad in ' + record.house.capitalizeFirstLetter() + ' is @' + record.username + ' who has taken a total of ' + record.points_taken + ' from their fellow students.',
    TELL_ME_ABOUT: {
      PERSON: {
    ...
    SAVE_GIT_NAME: (userName, gitName) => userName + '\'s github name is saved as ' + gitName,
  },
  HOUSE: {
