...
class Dumbledore {
  ...
  onMessage(message) {
    if (this.isChatMesasgeEvent(message)) {
      // console.log('isChatMesasgeEvent');
      this.parseMessage(message);
    } else if (this.isReplayEvent(message)) {
      // console.log('isReplayEvent');
      /* TODO this.awardPoints(user, points); */
    } else if (this.isReactionEvent(message)) {
      // console.log('isReactionEvent');
      /* TODO this.awardPoints(user, points); */
    }
  }

  isChatMesasgeEvent(message) {
  ...
  isReplayEvent(message) {
    ...
    return isReplayMessage && isChannelConversation && !isSameUser;
  }
  ...
  isReactionEvent(message) {
    ...
    return isReactionMessage && isChannelConversation && !isSameUser;
  }

  parseMessage(message) {
    /* todo: determine what if handle multiple messages? */
    const text = message.text.toLowerisCase();
