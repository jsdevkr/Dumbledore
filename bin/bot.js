 ...
 */
var token = 'xoxb-247710354992-YZWSaVVreR3BMQ3mXrLiXOsr';//process.env.BOT_API_KEY || 'xoxb-247710354992-YZWSaVVreR3BMQ3mXrLiXOsr';
var dbPath = '../data/dumbledore.db';//process.env.BOT_DB_PATH;
var name = 'ddb_hyeonwook';//process.env.BOT_NAME;
